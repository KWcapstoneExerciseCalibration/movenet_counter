...
class CameraSource(
    ...
    fun prepareCamera() {
        // Airysm: 카메라 전환
        val cameraDirectionToUse = if (frontcamera) {
        ...
        for (cameraId in cameraManager.cameraIdList) {
            ...
            if (cameraDirection != null && cameraDirection == cameraDirectionToUse) {
    ...
    private fun processImage(bitmap: Bitmap) {
        MainActivity.personForCount = mutableListOf<Person>()
