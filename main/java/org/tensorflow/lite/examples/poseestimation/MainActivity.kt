...
import org.tensorflow.lite.examples.poseestimation.airysm.PushupCounter
import org.tensorflow.lite.examples.poseestimation.airysm.WorkoutCounter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_convert.setOnClickListener {
            cameraSource?.onCameraButtonClicked()
            Log.d("Button", "camera convert")
        }
    }
