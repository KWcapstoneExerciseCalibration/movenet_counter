...
class SquatCounter : WorkoutCounter() {
    ...
    override fun correctAlgorithm(person: Person): Int {
        Log.d("SquatCorrect", "Squat correct Algorithm")
        ...
        if (   human.keyPoints[BodyPart.LEFT_SHOULDER.ordinal].score >= MIN_CONFIDENCE
            ...
            if (human.keyPoints[BodyPart.LEFT_HIP.ordinal].coordinate.y <= human.keyPoints[BodyPart.LEFT_KNEE.ordinal].coordinate.y) {
                correct -= 5
                // tts 프로그램
            }
        }
